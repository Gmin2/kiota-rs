...
use std::sync::Arc;
use kiota_abstractions::{BaseRequestBuilder, DefaultQueryParameters, HttpMethod, KiotaError, RequestAdapter, RequestConfiguration, RequestInformation};
...
impl PostItemRequestBuilder {
    ...
    pub async fn delete(&self, config: Option<&RequestConfiguration<DefaultQueryParameters>>) -> Result<Option<Vec<u8>>, KiotaError> {
        ...
        // TODO: wire up actual deserialization via request_adapter.send()
        todo!()
    }
    /// Get post by ID
